        ...
        <div className=" m-12 ">
          <div className=" flex flex-col border-2 border-primary p-14 space-y-2 ">
            ...
            <span className="flex  flex-row  ">
              <label for="birthday" className=" w-36  ">
                Name:
              </label>

              <input
                className=" outline-none border-2 w-72 rounded border-primary pl-1"
                type="text"
            ...
            <p>{name}</p>
            <span className=" flex  flex-row ">
              <label for="email" className=" w-36">
                Email:
              </label>
            ...
            <span className="flex  flex-row ">
              <label for="mobile" className=" w-36">
                {" "}
                Mobile No:
              </label>
            ...
            <span className="flex  flex-row ">
              <label for="gender" className=" w-36">
                {" "}
                Gender:
              </label>
              ...
              <select
                id="country"
                name="country"
                className=" outline-none border-2 rounded border-primary pl-1"
            ...
            <span className="flex  flex-row ">
              <label for="added" className=" w-36">
                {" "}
                Added By:
              </label>
            ...
            <span className="flex  flex-row ">
              ...
              <input
                ...
                id="birthday"
                name="birthday"
                className=" outline-none pl-1 border-2 rounded border-primary"
            ...
            <span className="flex  flex-row ">
              <label for="address" className=" w-36">
                Adress:
              </label>
            ...
            <span className="flex  flex-row ">
              <label for="state" className=" w-36 ">
                State:
              </label>
            ...
            <div className="  mt-10 ">
              <button
                className="border-0 text-white float-right p-2 bg-primary text-lg rounded w-18"
                onClick={create}
              >
                Submit
              </button>

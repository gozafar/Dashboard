            ...
            <div className=" space-y-3 r">
                <div className="flex justify-center ml-5">
                    <div className=" h-16 w-96 text-white">
                        <h1><span className="text-3xl font-bold">Sign Up </span><span><p>it's quick and easy</p></span></h1>
                    </div>
                </div>
                ...
                <div className="flex justify-center ">
                    <div className="space-x-14 ">
                        <input className=" p-2 outline-none border-2 w-40 rounded-lg border-primary pl-1" type="text"
                ...
                <div className="flex justify-center ">
                    <div>
                        <input className="p-2 w-96 outline-none border-2 rounded-lg border-primary pl-1" type="text"
                            placeholder="Enter Your Mobile" onChange={(event) => setMobile(event.target.value)} />
                    </div>
                </div>
                ...
                <div className="flex justify-center ">
                    ...
                    <div className="w-96 space-x-14">
                        <input type="date" id="birthday" name="birthday" className="w-42 p-2 outline-none pl-1 border-2 rounded-lg border-primary"
                            onChange={(event) => setDob(event.target.value)} />




                        <select id="country" name="country" className=" w-36 border-2 p-2 border-primary outline-none rounded-lg " onChange={(event) => setGender(event.target.value)}>
                ...
                <div className="flex justify-center ">
                    <div>
                        <button className="border-2 w-96 p-2 outline-none border-primary rounded-lg font-bold text-white bg-red-500" onClick={handle}>Sign Up</button>
                    </div>
                </div>
